...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'template_context_processors.main_processors.get_categories',
                'template_context_processors.main_processors.get_drafted_posts_count',
                'template_context_processors.main_processors.get_username',
                'template_context_processors.main_processors.is_disqus_enabled',
            ],
        },
    },
]
